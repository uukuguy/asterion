...
```python
{
    ...
    "source_lock_path": "pathlight-bright-optimization-source-lock.json",
    "selected_case_scope_sha256": sha,
    "baseline_query_plan_sha256": sha,
    "candidate_query_plan_sha256": sha,
    ...
    "budget_sha256": sha,
    "candidate_prompt_path": "prompts/query-planning-<sha256>.txt",
    "output_root_device": 0,
    "output_root_inode": 0,
