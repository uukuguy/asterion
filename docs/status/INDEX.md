...
| `PRIME-TYPICAL-APPLICATIONS.md` | 🟢 active | Canonical Prime seven-scenario worklist; P1–P6 development closures are CLI verified and P7 is the active next scenario; production promotion remains separate. |
