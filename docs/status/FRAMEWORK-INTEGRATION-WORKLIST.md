...
| W1c | Framework/product boundary | `runtime/defaults.py` has no Prime application routing; provider-owned integration supplies exact bindings. Agent runtime and control-plane responsibilities are documented as orthogonal contracts before Native routing changes | Active | W1b |
