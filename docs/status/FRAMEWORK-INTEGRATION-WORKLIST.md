...
| W3a | Cross-package evidence | Two different-domain extension wheels install, compose, and execute outside the source tree with deterministic ordering and exact bindings | Active | W2 |
