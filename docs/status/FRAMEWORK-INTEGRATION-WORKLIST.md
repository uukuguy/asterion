...
| W1d | Core-only boundary | Core import/install gate identifies and removes mandatory product dependencies and core-to-product imports without breaking provider entry points | Active | W1c |
