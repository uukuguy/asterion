...
.PHONY: prime-p1-run prime-p2-run prime-p3-run prime-p4-run
...
help:
	...
	@echo "Prime development execution (Orb Ubuntu): prime-p1-run prime-p2-run prime-p3-run prime-p4-run"
