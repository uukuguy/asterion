...
_PROBE_GOAL = (
    ...
    "call help or shell tools, write files, or perform unrelated work. In its first cell "
    "import asterion_control and execute exactly these two authorized effects in order:\n"
