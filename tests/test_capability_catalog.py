...
class CapabilityCatalogTests(unittest.TestCase):
    ...
    def test_accepts_the_closed_capability_protocol_fixture(self) -> None:
    ...
    def test_rejects_the_legacy_package_identity_field(self) -> None:
        value = manifest("example.research")
        value["package_id"] = value.pop("capability_id")
    ...
    def test_capability_ref_is_slotted_immutable_and_has_exact_selector(self) -> None:
        ref = CapabilityRef("example.research", "1.0.0")

        self.assertEqual(ref.selector, "example.research@1.0.0")
