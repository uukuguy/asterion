...
class TestDciBenchmarkInstances(unittest.TestCase):
    ...
    def test_beir_scifact_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.beir.scifact@1.0.0")

        self.assertEqual(instance.implementation_state, "implemented")
        self.assertEqual(resolve_case_limit(instance, case_limit=50, all_cases=False), 50)
        self.assertEqual(resolve_case_limit(instance, case_limit=None, all_cases=True), 300)
        self.assertEqual(instance.task_ids, ("beir.scifact",))

    def test_bright_biology_is_implemented_with_bounded_and_full_ranges(self) -> None:
        ...
        self.assertEqual(instance.task_ids, ("bright.biology",))

    def test_bright_earth_science_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.bright.earth-science@1.0.0")
    ...
    def test_bright_robotics_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.bright.robotics@1.0.0")
    ...
    def test_hotpotqa_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.qa.hotpotqa@1.0.0")

        self.assertEqual(instance.implementation_state, "implemented")
        self.assertEqual(resolve_case_limit(instance, case_limit=50, all_cases=False), 50)
        self.assertEqual(resolve_case_limit(instance, case_limit=None, all_cases=True), 7405)
        self.assertEqual(instance.task_ids, ("qa.hotpotqa",))

    def test_musique_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.qa.musique@1.0.0")
    ...
    def test_triviaqa_is_implemented_with_bounded_and_full_ranges(self) -> None:
        instance = select_benchmark_instance("dci.qa.triviaqa@1.0.0")
        self.assertEqual(instance.implementation_state, "implemented")
        self.assertEqual(resolve_case_limit(instance, case_limit=50, all_cases=False), 50)
        self.assertEqual(resolve_case_limit(instance, case_limit=None, all_cases=True), 11313)
        self.assertEqual(instance.task_ids, ("qa.triviaqa",))
