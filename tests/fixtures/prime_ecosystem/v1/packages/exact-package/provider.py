"""Provider factory for the Prime ecosystem package fixture."""
...
if os.environ.get("ASTERION_TEST_FORBID_PROVIDER_IMPORT") == "1":
    raise RuntimeError("provider imported during package metadata discovery")


PACKAGE_REF = CapabilityPackageRef("ecosystem.sample", "1.0.0")
SOURCE_ID = "ecosystem.sample.local-directory"
