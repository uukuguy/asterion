...
const candidate={active_session_id:"active-1",session_id:"native-1",initial_attach_cursor:{generation:"gen-1",sequence:6},cursor:{generation:"gen-1",sequence:7},transcript_sha256:"sha256:"+"a".repeat(64),tree_sha256:"sha256:"+"b".repeat(64),artifact_sha256:"sha256:"+"c".repeat(64),settled_model_callback_count:2,settled_tool_callback_count:1};
...
class TestPrimeP4DevelopmentGateway(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_runs_fixed_p4_flow_with_private_checkpoint_readback(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(
                first["checkpoint_candidate"]["initial_attach_cursor"]["sequence"], 6
            )
