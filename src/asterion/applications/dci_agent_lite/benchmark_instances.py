...
_INSTANCES = tuple(
    sorted(
        (
            ...
            DciBenchmarkInstance(
                instance_id="dci.beir.arguana",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.beir.arguana", "1.0.0"),
                task_ids=("beir.arguana",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=1406,
                cost_class="agent-judge-bounded",
            ...
            DciBenchmarkInstance(
                instance_id="dci.bright.earth-science",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.bright.earth-science", "1.0.0"),
                task_ids=("bright.earth-science",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=116,
                cost_class="agent-judge-bounded",
            ...
            DciBenchmarkInstance(
                instance_id="dci.bright.economics",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.bright.economics", "1.0.0"),
                task_ids=("bright.economics",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=103,
                cost_class="agent-judge-bounded",
            ...
            DciBenchmarkInstance(
                instance_id="dci.bright.robotics",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.bright.robotics", "1.0.0"),
                task_ids=("bright.robotics",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=101,
                cost_class="agent-judge-bounded",
            ...
            DciBenchmarkInstance(
                instance_id="dci.qa.2wikimultihopqa",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.qa.2wikimultihopqa", "1.0.0"),
                task_ids=("qa.2wikimultihopqa",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=12576,
                cost_class="agent-judge-bounded",
                implementation_state="implemented",
            ),
            DciBenchmarkInstance(
            ...
            DciBenchmarkInstance(
                instance_id="dci.qa.musique",
                version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.qa.musique", "1.0.0"),
                task_ids=("qa.musique",),
                executor_profile="real-agent-judge",
                default_case_limit=1,
                all_case_count=2417,
            ...
            DciBenchmarkInstance(
                instance_id="dci.qa.nq", version="1.0.0",
                application_ref=ApplicationRef("dci.complete-application", "1.0.0"),
                suite_ref=BenchmarkSuiteRef("dci.qa.nq", "1.0.0"),
                task_ids=("qa.nq",), executor_profile="real-agent-judge",
