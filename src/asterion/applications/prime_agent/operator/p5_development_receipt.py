...
class P5DevelopmentReceipt:
    ...
    first_quality_sha256: str
    second_quality_sha256: str
    feedback_sha256: str
    artifact_sha256: str
    usage_sha256: str
    prompt_count: int
    ...
    same_session: bool
    same_container: bool
    first_result_passed: bool
    second_result_passed: bool
    first_quality_failed: bool
...
_TRUTHS: Final = (
    ...
    "same_container",
    "first_result_passed",
    "second_result_passed",
    "first_quality_failed",
    "second_quality_passed",
    "workspace_changed",
    "full_cleanup",
)
...
def validate_p5_development_receipt(receipt: object) -> None:
    if (
        type(receipt) is not P5DevelopmentReceipt
        ...
        or receipt.workload_sha256 != P5_DEVELOPMENT_WORKLOAD_DIGEST
        or receipt.schema_sha256 != P5_DEVELOPMENT_SCHEMA_DIGEST
        or receipt.model_sha256 != P5_DEVELOPMENT_MODEL_DIGEST
        or receipt.oracle_sha256 != P5_DEVELOPMENT_ORACLE_DIGEST
