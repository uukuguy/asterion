...
_PROTOCOL: Final = "asterion.prime-p6-development-gateway/v1"
...
class PrimeP6DevelopmentGateway(DevelopmentGatewayTransport):
        ...
        *,
        ...
        try:
            super().__init__(
                ...
                / "packages/typescript/prime-gateway/dist/src/p6-development-main.js",
    ...
    def __repr__(self) -> str:
        return "PrimeP6DevelopmentGateway(redacted)"
