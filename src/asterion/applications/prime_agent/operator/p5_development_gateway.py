...
class PrimeP5DevelopmentGatewayError(ValueError):
    def __init__(self, *_: object) -> None:
        super().__init__("prime P5 development gateway is unavailable")
        ...
        *,
        ...
        try:
            super().__init__(
                ...
                / "packages/typescript/prime-gateway/dist/src/p5-development-main.js",
