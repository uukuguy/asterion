...
def _serve(args: argparse.Namespace) -> None:
    ...
    def control(raw: object) -> object:
        ...
        if raw["method"] == "seal":
            seal = broker.seal(); return {"transcript_sha256": seal.transcript_sha256, "score_sha256": seal.score_sha256, "initial_sha256": seal.initial_sha256, "actions_sha256": seal.actions_sha256, "status_sha256": seal.status_sha256, "terminal_reason": seal.terminal_reason, "action_count": seal.action_count}
