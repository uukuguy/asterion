"""Private six-stage DeepSeek adapter for the structured P6 SDK bridge."""
...
P6_PROVIDER_CALLBACK_LIMIT = _MAX_REQUESTS
P6_PROVIDER_INPUT_LIMIT = _TOTAL_INPUT_TOKENS
P6_PROVIDER_OUTPUT_LIMIT = _TOTAL_OUTPUT_TOKENS
P6_PROVIDER_COST_LIMIT = _TOTAL_COST_MICROUNITS
P6_PROVIDER_DEADLINE_SECONDS = int(_DEADLINE_SECONDS)
P6_PROVIDER_OUTPUT_LIMITS = _OUTPUT_LIMITS


class PrimeP6DevelopmentSdkProviderError(ValueError):
    """Body-free P6 development SDK provider failure."""

    def __init__(self, *_: object) -> None:
        super().__init__("prime P6 development SDK provider is unavailable")


class PrimeP6DevelopmentSdkProvider:
    """Translate only the captured four-call P6 SDK conversation."""
    ...
    def __init__(self, config: _PrivatePrimeModelConfig) -> None:
        if type(config) is not _PrivatePrimeModelConfig:
            raise PrimeP6DevelopmentSdkProviderError()
        self._calls = 0
    ...
    def __repr__(self) -> str:
        return "PrimeP6DevelopmentSdkProvider(redacted)"
    ...
    async def __call__(self, body: bytes) -> bytes:
        ...
        try:
            ...
            raise PrimeP6DevelopmentSdkProviderError() from None
...
def create_prime_p6_development_sdk_provider(
    operator_config: Mapping[str, object],
) -> PrimeP6DevelopmentSdkProvider:
    try:
        return PrimeP6DevelopmentSdkProvider(
...
__all__ = (
    "PrimeP6DevelopmentSdkProvider",
    "PrimeP6DevelopmentSdkProviderError",
    "create_prime_p6_development_sdk_provider",
    "P6_PROVIDER_OUTPUT_LIMITS",
)
