...
class PrimeExecutionResult:
    native_events: tuple[PiRpcEvent, ...]
    final_text: str

    def __repr__(self) -> str:
        return "<PrimeExecutionResult redacted>"


class PrimeExecutionKernel:
    """The sole native event validator, tool ledger and run-event producer."""
    ...
    async def _invoke(
        ...
        while True:
            ...
            round_index += 1
            prompt = (
                "Continue the current task from its retained state."
