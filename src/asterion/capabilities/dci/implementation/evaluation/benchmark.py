...
from asterion.capabilities.dci.implementation.config import DciPaths, DciRuntimeOptions
...
from asterion.capabilities.dci.implementation.reproduction.reproduction import compile_run_manifest, write_run_manifest
...
def _publish_reproduction_evidence(
    *,
    ...
    for result in results:
        ...
        evidence = {
            "schema": "asterion.capabilities.dci.implementation.reproduction.reproduction-evidence/v1",
            "query_id": query_id,
