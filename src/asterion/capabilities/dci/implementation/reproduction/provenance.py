...
DCI_COMPLETE_IMPLEMENTATION_RESOURCES: tuple[str, ...] = (
    "implementation/complete.py",
    "implementation/config.py",
    "implementation/datasets.py",
    "implementation/evaluation/analysis.py",
    "implementation/evaluation/artifacts.py",
    "implementation/evaluation/benchmark.py",
    "implementation/evaluation/evaluation.py",
    "implementation/evaluation/judge.py",
    "implementation/evaluation/metrics.py",
    "implementation/evaluation/resolution_metrics.py",
    "implementation/implementation.py",
    "implementation/private_values.py",
    "implementation/reproduction/ablation.py",
    "implementation/reproduction/paper_benchmarks.py",
    "implementation/reproduction/provenance.py",
    "implementation/reproduction/reproduction.py",
    "implementation/reproduction/verification.py",
    "implementation/research/context_extension.py",
    "implementation/research/context_profiles.py",
    "implementation/research/experiment_profiles.py",
    "implementation/research/prompts.py",
    "implementation/research/trajectory_resolution.py",
    "implementation/runtime/bridge.py",
    "implementation/runtime/pi_rpc.py",
    "implementation/runtime/run.py",
    "implementation/runtime_adapter.py",
    "implementation/services.py",
    "payload/benchmark-suites/all.json",
    "payload/benchmark-suites/github.json",
    "payload/benchmark-suites/paper-main.json",
    "payload/capabilities/dci-analysis.json",
    "payload/capabilities/dci-benchmark.json",
    "payload/capabilities/dci-evaluation.json",
    "payload/capabilities/dci-export.json",
    "payload/capabilities/dci-research.json",
    "payload/capabilities/local-corpus-policy.json",
    "payload/capability-package.json",
    "payload/conformance/profile.json",
...
def _read_implementation_resource(name: str) -> bytes:
    if not _canonical_resource_name(name):
        raise ValueError("DCI implementation resource closure is invalid")
    return resources.files("asterion.capabilities.dci").joinpath(name).read_bytes()
