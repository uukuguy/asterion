...
from asterion.capabilities.dci.implementation.reproduction.paper_benchmarks import resolve_paper_experiment_scope
...
def _query_evidence_from_batch(
    *,
    ...
    if reproduction is not None and (
        reproduction.get("schema") != "asterion.capabilities.dci.implementation.reproduction.reproduction-evidence/v1"
